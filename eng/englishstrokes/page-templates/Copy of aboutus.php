...
<div class="page-content teachers">
	...
	<div class="left-container">
			...
			jwplayer("meet-the-gang").setup({
				...
				playlist: [{
					...
					sources: [{
					  ...
					  file: "<?php bloginfo('template_url');?>/images/Intro_of_Characters.m4v",
					  file: "<?php bloginfo('template_url');?>/images/Intro_of_Characters.ogv",
					  label: "360p SD"
					},{
					  file: "<?php bloginfo('template_url');?>/images/Intro_of_Characters.mp4",
					  label: "720p HD"
					...
					tracks: [{ 
					  file: "<?php bloginfo('url'); ?>/uploads/captions/testCaps.vtt",
					  kind: "captions",
					  label: "On"  
					}]
				}],
		...
		<div style="font-family: Mangal">??????? ???</div>
