...
<?php
include('sidebar.php');/*$id = $_REQUEST['id'];
...
<table align="right" width="200" border="0">
    <tr>
        <td>
        <a class="list-action-btn" href="">ODI</a>
        </td>
        <td>
...
?>
	<form method="post" action="process.php" enctype="multipart/form-data">
		<table align="center" width="450px" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				<td>Strikerate below 50:</td>
				<td>
					<input type="text" name="STRIKE_RATE_BELOW_50" class="login-txt" value="<?php echo $point['STRIKE_RATE_BELOW_50'];?>"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>Strikerate 120 above:</td>
				<td>
					<input type="text" name="STRIKE_RATE_121_ABOVE" class="login-txt" value="<?php echo $point['STRIKE_RATE_121_ABOVE'];?>"/>
				</td>
			</tr>
			<tr>
				<td>Four 3 to 5:</td>
            ...
            <tr>
            	<td>Economy Above 7.5:</td>
                <td>
                	<input type="text" name="ECONOMY_RATE_ABOVE_7.5" class="login-txt" value="<?php echo $point['ECONOMY_RATE_ABOVE_7.5'];?>"/>
                </td>
            </tr>
            <tr>
            	<td>Economy Below 5:</td>
                <td>
                	<input type="text" name="ECONOMY_RATE_BELOW_5" class="login-txt" value="<?php echo $point['ECONOMY_RATE_BELOW_5'];?>"/>
                </td>
            </tr>
            <tr>
            	<td>Wides:</td>
        ...
        <input type="hidden" name="action" value="odipointedit"/>
	</form>
	</div>
<?php
include "footer.php";
