...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'KITTYEDIT')
{
	$percentage = $_REQUEST['txtpercentage'];
	$id = $_REQUEST['id'];
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'DELETEKITTY')
{
	$id = $_REQUEST['id'];
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'FEE')
{
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'FEEEDIT')
{
	$amount = $_REQUEST['txtamount'];
	$id = $_REQUEST['id'];
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'DELETEFEE')
{
	$id = $_REQUEST['id'];
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'PLAYER')
{
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'PLAYEREDIT')
{
	$player = $_REQUEST['txtplayer'];
	$id = $_REQUEST['id'];
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'DELETEPLAYER')
{
	$id = $_REQUEST['id'];
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'TOURNTYPE')
{
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'TOURNTYPEEDIT')
{
	$type = $_REQUEST['txttourtype'];
	$id = $_REQUEST['id'];
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'DELETETOURNTYPE')
{
	$id = $_REQUEST['id'];
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'PRIZEPOOL')
{
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'PRIZEPOOLEDIT')
{
	$prizepoolname = $_REQUEST['txtprizepool'];
	$id = $_REQUEST['id'];
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'DELETEPRIZEPOOL')
{
	$id = $_REQUEST['id'];
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'TOURNAMENT')
{
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'TOURNAMENTEDIT')
{
	$id = $_REQUEST['id'];
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'DELETETOURNAMENT')
{
	$id = $_REQUEST['id'];
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'ODIPOINTEDIT')
{
	$odipoints = $_POST;
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'TTWENTYEDIT')
{
	$t20points = $_POST;
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'TESTPOINTEDIT')
{
	$testpoints = $_POST;
...
else if(isset($_REQUEST['action']) && strlen($_REQUEST['action']) && strtoupper($_REQUEST['action']) == 'LOGIN')
{
	$username = $_REQUEST['username'];
	$password = $_REQUEST['password'];
	$sql = "SELECT * FROM coc_admin_users WHERE email = '".$username."' AND password = '".$password."'";
	$resultResource = mysql_query($sql);
