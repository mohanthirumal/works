...
<div style="float:left; margin-top:10px; width:100%;">
	...
	<form method="post" action="process.php" enctype="multipart/form-data">
		<table align="center" width="450px" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				<td>No of Changes:</td>
				<td>
                	<!--<input type="text" name="txtchanges" class="login-txt" value=""/>-->
                	<select name="txtchanges" class="login-txt">
						<?php
						//$sql = "SELECT * FROM coc_tournament ORDER BY (no_of_changes ='".$resulta['no_of_changes']."') DESC, id";
						$sql = "SELECT no_of_changes FROM coc_tournament where no_of_changes= '".$resulta['no_of_changes']."'";
						$resultResource = mysql_query($sql);
						$result = mysql_fetch_array($resultResource);
							echo '<option value="'.$result['id'].'">'.$result['no_of_changes'].'</option>'; //
	...
	<table width="80%" class="list" border="1" cellpadding="5px" cellspacing="0" align="center" style="margin-top:20px;">
		...
		<?php
			...
			$sql =	"select *,t.id as id,t.name as tname,k.percentage as kitty,fee.amount as amt,p.player as player,pp.name as prize,ttype.name as type,t1.team_nickname as team1,t2.team_nickname as team2 from coc_tournament t
