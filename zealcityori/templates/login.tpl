...
<div class="login-box-container">
	...
	<div class="login-box-body" id="login-form">
		<div class="login-box-body-left">
			...
			<a href="#" onclick="return zeal.facebook.login('signin');"><img src="{$base_dir}images/fbbutton.png" alt=""/></a>
		...
		<div class="login-box-body-right">
			...
			<div class="clear"></div>
			<div id="captcha-veri-container"{if !$showcaptcha} style="display:none;"{/if}>
			...
			<div class="txt-login-signup">
				<input type="submit" class="login-signup-btn" value="Login" id="btn-login"/> Or <a href="{$base_dir}forgot-password" id="forgot-password-txt">Forgot Password?</a>
			</div>
			<div class="clear"></div>
			</form>
		</div>
