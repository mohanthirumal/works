        ...
        <div class="login-box-container" style="height: 434px;">
            ...
            <div class="login-box-body" id="signup-body">
                <div class="login-box-body-left">
                    ...
                    <a href="#" onclick="return zeal.facebook.login('signup');"><img src="{$base_dir}images/fbbutton.png" alt=""/></a>
                   <!-- <img name="flogin" id="flogin" src="{$base_dir}images/f_connect.png" onclick="zeal.facebook.login('signup');" style="margin: 10px 1px 1px 91px;"/>-->
                ...
                <div class="login-box-body-right">
                    ...
                    <div class="txt-login-input">
                        ...
                        <div class="err_msg">
                        	 <div class="exist-image"><a href="#" alt="Minimum 5 to 15 alphanumeric characters" class="tooltip"><img src="{$base_dir}images/question_icon.png" class="q-mark-img"/></a></div>
                    ...
                    <div class="txt-login-input">
                        ...
                        <div class="err_msg">
                        	 <!--<div class="exist-image" title=""><img src="{$base_dir}images/question_icon.png" class="q-mark-img"/></div>-->
                    ...
                    <div class="txt-login-input">
                        ...
                        <div class="err_msg">
                        	 <div class="exist-image"><a href="#" alt="Minimum 8 alphanumeric characters" class="tooltip"><img src="{$base_dir}images/question_icon.png" class="q-mark-img"/></a></div>
