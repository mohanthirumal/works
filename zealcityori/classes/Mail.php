...
{	
	...
	public function emailInviteMail($to, $template, $user)
	{
		$subject = "Tournament invitation from zealcity.com";
		$message = file_get_contents(SITE_URL.'mail/'.$template.'.html');
	...
	public function send($to, $subject, $message)
	{
		...
		$mail->Username   = "webdev@zealcity.com"; // SMTP account username
		$mail->Password   = "zealcity123";        // SMTP account password
	...
	{
		$to = 'mohan@zealcity.com,support@zealcity.com,adit@zcstudio.com,a.r.karthik@zealcity.com';
