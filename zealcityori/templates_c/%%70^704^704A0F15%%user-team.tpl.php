<?php /* Smarty version 2.6.27, created on 2014-04-25 17:58:00
         compiled from user-team.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'user-team.tpl', 43, false),array('modifier', 'explode', 'user-team.tpl', 51, false),array('modifier', 'string_format', 'user-team.tpl', 51, false),array('function', 'math', 'user-team.tpl', 48, false),)), $this); ?>
<div class="center-container">
    <div class="myteam" id="myteam">        
        <div class="live-score-menu">
            <ul>
                <li class="active" onclick=""><?php echo $this->_tpl_vars['user']->username; ?>
</li>                
            </ul>
            <div style="float:right; margin:10px 10px 0 0;">
                <div><a href="#" onclick="zeal.userteam.closeUserTeam();">Back</a></div>
            </div>                 
        </div>
