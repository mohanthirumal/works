<?php /* Smarty version 2.6.27, created on 2014-04-11 14:40:07
        ...
        <div class="login-box-container" style="height: 434px;">
            ...
            <div class="login-box-body" id="signup-body">
                <div class="login-box-body-left">
                    <div class="facebook-photo" style="margin:130px 0 0 100px;"><img src="https://graph.facebook.com/<?php echo $this->_tpl_vars['id']; ?>
/picture?type=large" alt=""/></div>
                </div>
