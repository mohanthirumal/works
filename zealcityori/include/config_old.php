...
//Paypal Items
define('PAYPAL_MODE', '');
define('PAYPAL_USERNAME', 'adit_api1.zcstudio.com');
define('PAYPAL_PASSWORD', 'XWMDBJGAAMXPQABV');
define('PAYPAL_SIGNATURE', 'ADPZnF4Zvmdv-H6480PEkQE1VAXqATYyEZAr81PfTI30c3qH61v1X9fO');
